...
const Auth = ({ onLoginSuccess }) => {
  ...
  const handleAuth = async () => {
    ...
    try {
      if (isLogin) {
        const { data } = await axios.post("http://192.168.148.4:4001/api/auth/signin", {
          email,
          password,
        });
        ...
        const { data } = await axios.post("http://192.168.148.4:4001/api/auth/signup", {
          email,
          password,
        });
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const { data } = await axios.post("http://192.168.148.4:4001/api/auth/forgot-password", {
        email,
      });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const { data } = await axios.post("http://192.168.148.4:4001/api/auth/reset-password", {
        token: resetToken,
